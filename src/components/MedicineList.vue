<template>
    ...
    <div class="medicine-list-view">
      <div class="header">
        ...
        <h1>{{ selectedPharmacy.name }} - Medicines</h1>
      </div>
    ...
    created() {
      ...
      if (medicineData && medicineData.medicines) {
        ...
        this.medicines = this.allMedicines.filter(medicine => 
          medicine.pharmacyId === this.selectedPharmacyId
        )
        ...
        if (this.medicines.length === 0) {
          console.warn('No medicines found for pharmacy ID:', this.selectedPharmacyId)
